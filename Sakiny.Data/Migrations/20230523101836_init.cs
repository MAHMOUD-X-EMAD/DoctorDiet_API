        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cooker = table.Column<bool>(type: "bit", nullable: false),
                    Heater = table.Column<bool>(type: "bit", nullable: false),
                    TV = table.Column<bool>(type: "bit", nullable: false),
                    AirContidioner = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    Cupboard = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_cooker", x => x.ApplicationUserId);
                    table.ForeignKey(
                        name: "FK_cooker_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    IdentityImageId = table.Column<int>(type: "int", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_owners", x => x.ApplicationUserId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_owners_OwnerImages_IdentityImageId",
                        column: x => x.IdentityImageId,
                        principalTable: "OwnerImages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_apartments_aminities_AminitiesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_apartments_AminitiesId",
                table: "apartments",
                column: "AminitiesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_owners_IdentityImageId",
                table: "owners",
                column: "IdentityImageId");
