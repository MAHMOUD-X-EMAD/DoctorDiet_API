    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActivityRate", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ActivityRate_Patient_PatientID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CustomPlanId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Day_CustomPlans_CustomPlanId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_customPlanMealBridges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_customPlanMealBridges_CustomPlans_CustomPlanId",
                        column: x => x.CustomPlanId,
                        principalTable: "CustomPlans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_customPlanMealBridges_Meal_MealId",
                        column: x => x.MealId,
                        principalTable: "Meal",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_planMealBridges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_planMealBridges_Meal_MealId",
                        column: x => x.MealId,
                        principalTable: "Meal",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_planMealBridges_Plans_PlanId",
                        column: x => x.PlanId,
                        principalTable: "Plans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityRate_PatientID",
                table: "ActivityRate",
                column: "PatientID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_customPlanMealBridges_MealId",
                table: "customPlanMealBridges",
                column: "MealId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_planMealBridges_MealId",
                table: "planMealBridges",
                column: "MealId");

            migrationBuilder.CreateIndex(
                name: "IX_planMealBridges_PlanId",
                table: "planMealBridges",
                column: "PlanId");
